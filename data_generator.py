...
data_dir = "/root/data/videoanno/WPU-Net-master/pure_iron_grain_data_sets.hdf5"
...
# file=r'/root/data/videoanno/WPU-Net-master/pure_iron_grain_data_sets'
# real_image = os.path.join(file, 'image')
# real_label = os.path.join(file, 'label')
# real_boundary = os.path.join(file, 'boundary')
...
for item in range(0, 116):
    ...
    # crop
    print("output_train_crop_dir",output_train_crop_dir)
