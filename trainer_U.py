...
from segmentation.data_U_DPU import IronDataset
...
class Trainer(object):
    ...
    def __init__(self, bs=24, loss_type='abw', multi_layer=True, data_dir = '',workers=1):
        ...
        forward_train_vid=(IronDataset(train_vid_list,train_label_list, train=True, transform=self.transform, crop=True, crop_size=(256, 256), dilate=3))
        ...
        forward_val_vid=(IronDataset(val_vid_list,val_label_list, train=False, transform=self.transform, crop=False, crop_size=(256, 256), dilate=3))
        ...
        #///////////////////////////////////////////////
        #unet:
        self.model = UNet(num_channels=1, num_classes=2, multi_layer=self.multi_layer)
        #///////////////////////////////////////////////
        #WPU_Net
    ...
    def train(self, epoch, loss_list, plotimgs,temporary_folder):
        ...
        for batch_idx, (image, mask, last, next, weight) in enumerate(F):
            ...
            last[last == 255] = -6
            last[last == 0] = 1
            output = self.model(img, label,opposite_result=None)
...
if __name__ == "__main__":
    ...
    checkpoint_path = os.path.join(cwd, "UNet_model/",current_time)
